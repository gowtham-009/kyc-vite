...
function absolutePosition(element, target, gutter = true) {
  ...
  if (element) {
    ...
    if (gutter)
      element.style.marginTop = origin === "bottom" ? `calc(${(_b = (_a = getCSSVariableByRegex(/-anchor-gutter$/)) == null ? void 0 : _a.value) != null ? _b : "2px"} * -1)` : (_d = (_c = getCSSVariableByRegex(/-anchor-gutter$/)) == null ? void 0 : _c.value) != null ? _d : "";
  }
}
...
//# sourceMappingURL=chunk-RECV7Z6W.js.map
