import {
  script as script11
} from "./chunk-SLNVMDFJ.js";
import {
  script as script8,
  script2 as script9,
  script3 as script10
} from "./chunk-7FBJJE3H.js";
import {
  script as script4,
  script2 as script7
} from "./chunk-XGWJ43ZX.js";
import {
  script as script6
} from "./chunk-FHCFEWW3.js";
import {
  script as script5
} from "./chunk-IMVBIWX2.js";
import {
  Ripple
} from "./chunk-3JBDBESY.js";
import {
  BaseDirective
} from "./chunk-UDAMU2Z6.js";
import {
  script as script3
} from "./chunk-6H7JMGW6.js";
import {
  script as script2
} from "./chunk-INFXU7I5.js";
import "./chunk-BVT5SQTA.js";
import {
  script
} from "./chunk-OR46D7FX.js";
import "./chunk-B73TEBOQ.js";
import {
  FilterMatchMode,
  FilterOperator,
  FilterService
} from "./chunk-3FEREYQ4.js";
import "./chunk-X3KIWTM4.js";
import {
  BaseStyle
} from "./chunk-HDJE2HSG.js";
import {
  ZIndex,
  absolutePosition,
  addClass,
  ...
  setAttribute,
  sort
} from "./chunk-RECV7Z6W.js";
import {
  EventBus
} from "./chunk-OS4WUCNP.js";
import {
  Fragment,
  Transition,
  createBaseVNode,
  ...
  methods: {
    ...
    onScrollPositionChange: function onScrollPositionChange(event2) {
      ...
      var calculateFirst = function calculateFirst2(_currentIndex, _triggerIndex, _first, _last, _num, _numT, _isScrollDownOrRight, _isCols) {
        ...
        if (firstValue > maxFirst)
          return maxFirst - _num;
        else
          return firstValue;
      };
        ...
        if (this.optionGroupLabel) {
          ...
          optionGroups.forEach(function(group) {
            ...
            if (filteredItems.length > 0)
              filtered.push(_objectSpread2(_objectSpread2({}, group), {}, _defineProperty4({}, typeof _this18.optionGroupChildren === "string" ? _this18.optionGroupChildren : "items", _toConsumableArray2(filteredItems))));
          });
  ...
  methods: {
    ...
    isFilterBlank: function isFilterBlank(filter3) {
      if (filter3 !== null && filter3 !== void 0) {
        if (typeof filter3 === "string" && filter3.trim().length == 0 || filter3 instanceof Array && filter3.length == 0)
          return true;
        else
          return false;
      }
    ...
    exportCSV: function exportCSV$1(options2, data16) {
      ...
      if (!data16) {
        ...
        if (options2 && options2.selectionOnly)
          data16 = this.selection || [];
        else if (this.frozenValue)
          data16 = data16 ? [].concat(_toConsumableArray4(this.frozenValue), _toConsumableArray4(data16)) : this.frozenValue;
      }
    ...
    processedData: function processedData() {
      ...
      if (!this.lazy && !((_this$virtualScroller = this.virtualScrollerOptions) !== null && _this$virtualScroller !== void 0 && _this$virtualScroller.lazy)) {
        if (data16 && data16.length) {
          ...
          if (this.sorted) {
            if (this.sortMode === "single")
              data16 = this.sortSingle(data16);
            else if (this.sortMode === "multiple")
              data16 = this.sortMultiple(data16);
          }
        }
      }
      return data16;
...
function render30(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", mergeProps({
    ...
    content: withCtx(function(slotProps) {
      ...
      }, _objectSpread5(_objectSpread5({}, _ctx.tableProps), _ctx.ptm("table"))), [_ctx.showHeaders ? (openBlock(), createBlock(_component_DTTableHeader, {
        key: 0,
